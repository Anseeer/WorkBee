...
//     } else {
//     values.selectedServices.forEach((item, index) => {
//     if (!item.price || item.price <= 0) {
//       if (!errors.selectedServices) errors.selectedServices = [];
//       errors.selectedServices[index] = {
//         price: "Enter a valid price for this service"
//       };
//       }
//       });
//       }
...
//                 {service.map((service) => {
//                   const isSelected = formik.values.selectedServices.some(
...
//                         <span className="absolute left-full ml-2 bg-green-700 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 whitespace-nowrap transition-opacity pointer-events-none">
//                           ₹{service.price}
//                         </span>
//                       </label>
...
//                             <input
//                               type="text"
//                               // value={formik.values.service[service?.price] || ""}
//                               // onChange={(e) => handlePriceChange(service.id, e.target.value)}
//                               onBlur={() => formik.setFieldTouched(`price_${service.id}`, true)}
...
//                           </div>
//                           {formik.errors.selectedServicePrice  && formik.touched.selectedServicePrice (
//                             <div className="text-red-500 text-xs mt-1">
//                               {formik.errors.selectedServicePrice}
//                             </div>
//                           )}
//                         </div>
//                       )}
