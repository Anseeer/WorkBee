...
//                                                 <label
//                                                     className={`flex items-center justify-between p-3 border rounded-lg cursor-pointer transition ${isSelected
...
//                                                 {isSelected && (
//                                                     <div className="ml-7 pl-4 border-l-2 border-green-200 space-y-1">
...
//                                                                 className={`flex-1 px-3 py-2 border rounded-lg focus:ring-2 focus:ring-green-600 focus:border-transparent outline-none text-sm ${servicePriceErrors[service.id]
//                                                                         ? "border-red-500"
//                                                                         : "border-gray-300"
//                                                                     }`}
//                                                             />
