  ...
  <div className="bg-gray-50 flex flex-col items-center p-2">
    <main className="w-full max-w-4xl">
      ...
      <div className="rounded-lg flex flex-col items-center">
        <div className="bg-gradient-to-r from-green-700 to-blue-900 text-white rounded-xl 
                        p-5 w-[280px] h-[140px] sm:w-[320px] sm:h-[150px] 
          ...
          <img
            ...
            alt="Card"
            className="w-12 h-8 sm:w-15 sm:h-10"
          />
        </div>
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-2">
        ...
        {history.length > 0 ? (
          <div className="border rounded flex flex-col h-[220px] sm:h-[230px]">
            {/* Table Wrapper */}
            <div className="flex-1 overflow-auto">
              <table className="w-full text-left text-sm">
                <thead className="sticky top-0 bg-[#8FC39D] text-xs sm:text-sm">
                  <tr>
            ...
            {/* Pagination centered */}
            <div className="flex justify-center items-center gap-4 m-2 bg-white text-sm">
              <button
